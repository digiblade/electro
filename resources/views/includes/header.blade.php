        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> {{$data['contact']}}</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> {{$data['email']}}</a></li>
                    {{-- todo address --}}
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="copyright">
                            ...
                            </script> All rights reserved with <i
                                class="fa fa-heart-o" aria-hidden="true"></i> by <a href=""
                                target="_blank">Digiblade</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </span>
                    </div>
                </div>
